...
def compute_MIND(surf_dir, features, parcellation, parcel_location,filter_vertices=False):

	vertex_data, regions, features_used = get_vertex_df(surf_dir, features, parcellation, parcel_location)
