...
sns.boxplot(x='Group', y='MIND_Sig_Index', data=df, order=group_order, palette="Set2")
sns.stripplot(x='Group', y='MIND_Sig_Index', data=df, order=group_order, color=".3", alpha=0.4)
plt.title("Degeneration of MIND Network Index across Stages")
plt.savefig('Aim1_MIND_Trend.png')
...
if len(analysis_df) > 0:
    ...
    plt.savefig('Aim2_MIND_Prediction.png')
else:
