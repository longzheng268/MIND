...
def run_advanced_analysis():
    ...
    sns.violinplot(x='Group_MIND', y='Global_MIND', data=meta, palette='muted', inner="quart")
    sns.stripplot(x='Group_MIND', y='Global_MIND', data=meta, color="black", alpha=0.3)
    plt.title("Edge-wise Global Mean MIND Distribution across 4 Groups")
    plt.savefig(os.path.join(OUTPUT_DIR, "Global_Edge_Boxplot.png"), dpi=300)
    ...
    for g1, g2 in combinations(GROUPS, 2):
        ...
        sns.heatmap(t_img, cmap='RdBu_r', center=0, xticklabels=10, yticklabels=10)
        plt.title(f"Edge-wise T-statistic Matrix: {g1} vs {g2}")
        plt.savefig(os.path.join(OUTPUT_DIR, f"Edge_Tmap_{g1}_vs_{g2}.png"), dpi=300)
