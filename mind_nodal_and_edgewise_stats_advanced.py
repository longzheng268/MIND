...
def run_advanced_analysis():
    ...
    sns.boxplot(x='Group_MIND', y='Edge_Strength', data=df_final, order=GROUPS, palette='Set2')
    sns.stripplot(x='Group_MIND', y='Edge_Strength', data=df_final, color=".3", alpha=0.3, order=GROUPS)
