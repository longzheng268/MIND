...
def run_edge_analysis():
    ...
    sns.heatmap(anova_res_mat, cmap='viridis_r', vmax=0.05)
    ...
    for g1, g2 in combinations(GROUPS, 2):
        ...
        plt.figure(figsize=(10, 8))
        sns.heatmap(t_mat, cmap='RdBu_r', center=0)
    ...
    sns.boxplot(x='Group_MIND', y='best_edge', data=meta, palette='Set3')
    sns.swarmplot(x='Group_MIND', y='best_edge', data=meta, color=".25", size=3)
