...
def plot_mean_surface(mean_values, group_name):
    ...
    plotting.plot_surf_stat_map(
        ...
        colorbar=True, cmap=CMAP_DIVERGING, threshold=None, darkness=None,
    ...
    plt.suptitle(f"Mean Spatial Distribution: {group_name}", fontsize=FONT_SUPTITLE)
    file_name = f"Mean_Spatial_Map_{group_name}.png"
    plt.savefig(os.path.join(OUTPUT_DIR, file_name), dpi=DPI, bbox_inches='tight')
